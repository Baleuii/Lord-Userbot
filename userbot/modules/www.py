...
async def pingme(pong):
    ...
    start = datetime.now()
    await pong.edit("⭐")
    await pong.edit("__**WOLV⭐**__")
    await pong.edit("__**WOL⭐V**__")
    await pong.edit("__**WO⭐LV**__")
    await pong.edit("__**W⭐OLV**__")
    await pong.edit("__**⭐WOLVES⭐**__")
    end = datetime.now()
    duration = (end - start).microseconds / 1000
...
async def pingme(pong):
    ...
    await pong.edit("**⭐⭐**")
    await pong.edit("**⭐⭐⭐**")
    await pong.edit("**✦҈͜͡➳ PING!**")
    end = datetime.now()
    duration = (end - start).microseconds / 1000
    await pong.edit(f"** W O L V E S**\n"
                    f"❃ **Ping:** "
                    f"`%sms` \n"
                    f"❃ **Uptime:** "
                    f"`{uptime}` \n"
                    f"**✦҈͜͡➳ Tuanku:** `{ALIVE_NAME}`" % (duration))
